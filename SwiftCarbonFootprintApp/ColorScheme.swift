...
extension Color {
    var value: UIColor {
        ...
        case .darkBackground:
            instanceColor = UIColor(hexString: "#585a56")
        case .lightBackground:
            instanceColor = UIColor(hexString: "#c2d3da")
        case .intermidiateBackground:
            instanceColor = UIColor(hexString: "#81a3a7")
        case .darkText:
            instanceColor = UIColor(hexString: "#333333")
        case .intermidiateText:
            instanceColor = UIColor(hexString: "#999999")
        case .lightText:
            instanceColor = UIColor(hexString: "#f1f3f2")
        case .affirmation:
